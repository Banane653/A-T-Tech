...
export default function RegisterQrCode({ registerUrl, merchantName }: RegisterQrCodeProps) {
  const t = useTranslations('RegisterQrCode');
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-1.5 non-printable">
        <button
        ...
        <span className="text-[11px] text-gray-400 font-medium">{t('printLabel')}</span>
      </div>
